...
public class Story2 extends JFrame {
	...
	public Story2() {
		...
		btnNewButton_7.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				TimerTask timer=new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(200, 426, 170, 68);
						if (inv.getCrossersOnBoat().contains(StoryTwo.getFarmer40()))
				...
				time.schedule(timer,100);
				 timer=new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(300, 426, 170, 68);
						if (inv.getCrossersOnBoat().contains(StoryTwo.getFarmer40()))
				...
				timer =new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(400, 426, 170, 68);
				...
				timer =new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(440, 426, 170, 68);
						if (inv.getCrossersOnBoat().contains(StoryTwo.getFarmer40()))
				...
				timer =new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(500, 426, 170, 68);
						if (inv.getCrossersOnBoat().contains(StoryTwo.getFarmer40()))
				...
				timer =new TimerTask() {
					...
					@Override
					public void run() {
						lblNewLabel_11.setBounds(550, 426, 170, 68); 		
						if (inv.getCrossersOnBoat().contains(StoryTwo.getFarmer40()))
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			...
			else if( lblNewLabel_10.getBounds().contains(263, 399) ) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				else if( lblNewLabel_6.getBounds().contains(10, 422) ) {
				...
				else if( lblNewLabel_6.getBounds().contains(200, 380) ) {
					lblNewLabel_6.setBounds(10, 422, 67, 88);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			else if( lblNewLabel_7.getBounds().contains(89, 419) ) {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			else if( lblNewLabel_9.getBounds().contains(194, 383) ) {
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			...
			else if( lblNewLabel_8.getBounds().contains(140, 399) ) {
			...
			else if( lblNewLabel_8.getBounds().contains(200, 380) ) {
				lblNewLabel_8.setBounds(140, 399, 76, 88);
